...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long>{
	...
	List<Restaurant> findByCategories(Categorie categorie);

	@Query("from Restaurant r left join fetch r.adresse a where a.ville like :ville and r.categories like :categorie")
	List<Restaurant> findByCategoriesAndVille(@Param("categorie") Categorie categorie, @Param("ville") String ville);
